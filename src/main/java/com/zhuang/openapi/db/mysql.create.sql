...
CREATE TABLE `sys_openapi_log`  (
                                   ...
                                   `api_name` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT 'api名字',
                                   `api_params` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT 'api参数值',
                                   `api_execute_times` int(11) NULL DEFAULT NULL COMMENT '接口执行时间（单位：毫秒）',
                                   `client_ip` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '客户端ip',
                                   `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
                                   `openapi_user_id` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                   PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'OpenApi调用日志' ROW_FORMAT = Dynamic;
